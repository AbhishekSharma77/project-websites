...
medical_keywords = [
    "Predictive Analytics", "Machine Learning", "Equipment Failure Prediction", "Condition Monitoring", "Maintenance Scheduling", "Sensor Data Analysis", "Fault Detection", "Reliability Engineering", "Anomaly Detection", "Time Series Forecasting", "Industrial IoT (IIoT)", "Prognostics and Health Management (PHM)", "Preventive Maintenance", "Downtime Reduction", "Data-Driven Maintenance"
]
